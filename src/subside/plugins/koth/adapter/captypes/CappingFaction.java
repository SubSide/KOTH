...
public class CappingFaction extends Capper {
    private com.massivecraft.factions.entity.Faction faction;
    
    public CappingFaction(com.massivecraft.factions.entity.Faction faction){
    ...
    public CappingFaction(List<Player> playerList2){
    ...
    public static Capper getFromUniqueName(String name){
        return new CappingFaction(com.massivecraft.factions.entity.FactionColl.get().get(name));
    }
}
